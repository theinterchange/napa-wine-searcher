  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      <header className="mb-10">
        <span className="kicker">Legal · Last updated 2026-03-30</span>
      ...
      <div className="editorial-prose">
        ...
        <p>For any data requests we cannot fulfill through the site, contact us at the email below. We will respond within 30 days.</p>
        ...
        <p>
          ...
          <a href="mailto:theinterchangestudio@gmail.com">theinterchangestudio@gmail.com</a>.
        </p>
      </div>
    </div>
  );
