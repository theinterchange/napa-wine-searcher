...
const AccommodationEditorial = z.object({
  ...
  theSetting: z.string().describe(
    "3-4 sentences. What does this place LOOK like? Lead with the single most distinctive visual element — the one thing a guest would photograph first. The building's architecture, the garden, the view from the terrace. Then immediate surroundings. NEVER start with 'Nestled', 'The first thing', 'Upon entering', 'A striking'. BANNED phrases: 'nestled', 'rolling hills', 'sun-drenched', 'breathtaking', 'picturesque', 'lush vineyards', 'golden light', 'warm glow', 'enchanting', 'beckons'. If you can swap in another hotel's name and the description still works, it's too generic — rewrite it."
  ),
  theExperience: z.string().describe(
    "3-4 sentences. What is it ACTUALLY like to stay here? Reference real amenities — the pool, the spa, the restaurant, the wine bar, the concierge, specific room features. Drop the reader into a real moment from an actual stay. NEVER start with 'Imagine', 'Picture yourself', 'Whether you', 'Guests can', 'Your stay at', 'Staying here feels', 'Staying here means', 'Staying here is', 'A stay here', 'Mornings begin', 'Mornings here', 'Mornings start', 'Mornings unfold', 'Awakening to'. DO NOT start with a morning routine — vary wildly: an afternoon by the pool, an evening on the terrace, the feel of the sheets, the silence at night, a specific dish at dinner. BANNED phrases: 'Whether you', 'world-class', 'unparalleled', 'unforgettable', 'beckons', 'curated', 'immerse', 'breathtaking', 'picturesque', 'enchanting'."
  ),
  beforeYouBook: z.string().describe(
    "2-3 sentences of practical, scannable tips. NEVER start with 'Consider', 'Plan your', 'Before you', 'Be sure to', 'Peak season', 'Reservations', 'Booking well', 'Book well', 'Parking is', 'Parking'. Vary the opener — start with the most UNIQUE practical tip for THIS specific property (a room type to request, a season to avoid, a local secret). Don't lead with parking or check-in unless that's genuinely the most useful tip. Keep factual and brief — no flowery language."
  ),
...
- ABSOLUTELY BANNED words/phrases: "nestled", "rolling hills", "sun-drenched", "world-class", "unparalleled", "unforgettable", "beckons", "boasts", "palpable", "lush", "breathtaking", "warm glow", "golden light", "inviting atmosphere", "curated", "Whether you", "quintessential", "idyllic", "enchanting", "picturesque", "immerse"
- BANNED openers: Never start any field with "Nestled", "Located in", "Situated in", "Welcome to", "Imagine", "Picture yourself", "Consider", "Plan your", "As you", "For those seeking", "Guests can", "Your stay at", "At [property name]", "The first thing", "Upon entering", "Staying here feels", "Staying here means", "Staying here is", "A stay here", "Peak season", "Reservations", "Book well", "Booking well", "Mornings begin", "Mornings here", "Mornings start", "Mornings unfold", "Awakening to", "Parking is", "Parking"
